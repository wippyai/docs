...
| `temperature` | number | Temperatura de amostragem (padrao `0`; faixa depende do provedor) |
...
| `enable_cache` | Habilita marcadores de cache de prompt (modelos Claude). Padrao `true`. |
