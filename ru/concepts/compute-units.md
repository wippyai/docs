---
title: "Вычислительные единицы"
description: "Wippy предоставляет три способа выполнения кода: функции, процессы и workflows. Они используют одну и ту же базовую механику, но различаются временем…"
---
...
<note>
Wippy автоматически обеспечивает детерминизм для workflows. Не нужно изучать специальные техники — пишите обычный код, а среда исполнения обеспечит корректное поведение при воспроизведении.
</note>
