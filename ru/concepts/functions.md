...
См. [модуль funcs](lua-funcs.md) для полного API.
...
Контекст безопасности распространяется так же. Вызываемые функции видят актора вызывающего и могут проверять разрешения. См. [модуль security](lua-security.md) для API контроля доступа.
