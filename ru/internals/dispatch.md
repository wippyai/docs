---
title: "Диспатчинг команд"
description: "Система диспатчинга маршрутизирует команды от процессов к обработчикам. Процессы yield'ят команды с корреляционными тегами, обработчики выполняют…"
---
...
| 70-79 | tty | Терминальный ввод/вывод |
