---
title: "Обработчики записей"
description: "Обработчики записей обрабатывают записи реестра по kind. При добавлении, обновлении или удалении записей реестр диспатчит события соответствующим…"
---
