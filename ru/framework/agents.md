---
title: "Агенты"
description: "Модуль wippy/agent предоставляет фреймворк для создания AI-агентов с поддержкой инструментов, потоковой передачи, делегирования, трейтов и памяти.…"
---
...
|----------|--------------|----------|
| `max_items` | `3` | Максимальное количество элементов памяти за одно извлечение |
| `max_length` | `1000` | Максимальная общая длина в символах |
| `recall_cooldown` | `1` | Минимальное количество шагов между извлечениями |
| `min_conversation_length` | `2` | Минимальное количество ходов диалога до первого извлечения |
...
- [LLM](framework/llm.md) - Базовый модуль LLM
