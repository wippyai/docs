...
Предоставляется `wippy/migration`. Обнаруживает каждую запись с `meta.type: migration`, группирует их по `meta.target_db` и применяет ожидающие. См. [Миграции](migration.md).
...
- [Миграции](migration.md) - Загрузчик миграций и DSL
