...
Lua API для метрик см. в [модуле Metrics](lua-metrics.md).
...
- [Модуль Logger](lua-logger.md) — Lua API логирования
- [Модуль Metrics](lua-metrics.md) — Lua API метрик
- [Модуль System](lua-system.md) — статистика среды исполнения
