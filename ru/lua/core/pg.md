...
Объединение процессов в именованные группы и широковещательная рассылка каждому члену в кластере. Смоделировано по образцу Erlang/OTP `pg`: группы динамические, процесс может принадлежать многим группам, а членство отслеживается по всему кластеру через gossip.
