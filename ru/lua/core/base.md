...
Создание и управление корутинами. См. [Каналы и корутины](lua/core/channel.md) для каналов и паттернов конкурентности:
...
Создание и классификация структурированных ошибок. См. [Обработка ошибок](lua/core/errors.md) для полной документации:
...
- [Каналы и корутины](lua/core/channel.md) — каналы в стиле Go для конкурентности
- [Обработка ошибок](lua/core/errors.md) — создание и обработка структурированных ошибок
- [Системное время](lua/system/ostime.md) — функции системного времени
