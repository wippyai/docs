...
**Сигнатура:** `os.time([spec]) -> number`

**Параметры таблицы:**

| Поле | Тип | Значение по умолчанию | Описание |
|------|-----|-----------------------|----------|
| `year` | number | текущий год | Год (четыре цифры) |
| `month` | number | текущий месяц | Месяц (1–12) |
| `day` | number | текущий день | День месяца (1–31) |
| `hour` | number | 0 | Час (0–23) |
| `min` | number | 0 | Минуты (0–59) |
| `sec` | number | 0 | Секунды (0–59) |
...
| `timestamp` | number | текущее время | Время для форматирования |
...
| `%U` | Номер недели ISO 8601 (01–53, неделя начинается с понедельника) | 24 |
| `%W` | Номер недели ISO 8601 (01–53, неделя начинается с понедельника) | 24 |
| `%z` | Часовой пояс | -0700 |
...
|------|-----|----------|--------|
| `year` | number | Год | 2024 |
| `month` | number | Месяц (1–12) | 6 |
| `day` | number | День (1–31) | 15 |
| `hour` | number | Час (0–23) | 14 |
| `min` | number | Минуты (0–59) | 30 |
| `sec` | number | Секунды (0–59) | 45 |
| `wday` | number | День недели (1–7, вс=1) | 7 |
| `yday` | number | День года (1–366) | 167 |
...
|----------|-----|----------|
| `t2` | number | Конечное время |
| `t1` | number | Начальное время |

Возвращает разницу `t2 - t1` в секундах. Результат может быть отрицательным, если `t1 > t2`.
