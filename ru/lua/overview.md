...
См. [Управление процессами](lua-process.md) для создания, связывания и супервизии.
...
См. [Каналы](lua-channel.md) для select и паттернов.
...
Для собственных расширений см. [Модули](internal-modules.md) в документации внутреннего устройства.
...
См. [Обработка ошибок](lua-errors.md) для паттернов.

## Что дальше

- [Определения записей](lua-entries.md) — настройка точек входа
- [Каналы](lua-channel.md) — паттерны каналов
- [Управление процессами](lua-process.md) — создание и супервизия
- [Функции](lua-funcs.md) — межпроцессные вызовы
