---
title: "Testing"
description: "Пишите и запускайте тесты для вашего Lua-кода с помощью фреймворка wippy/test — это BDD-раннер с ассертами, хуками жизненного цикла и моками,…"
---
...
3. Успешный («зелёный») прогон тестов через `wippy test`.
