...
<note>
<code>hide_logs: true</code> убирает вывод логов с шины событий и из терминала. Процесс, владеющий поверхностью, публикует целые кадры, поэтому всё остальное, что пишет в тот же терминал, их портит.
</note>
