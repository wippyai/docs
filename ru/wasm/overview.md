...
## Вызовы между WASM-модулями

WASM-компоненты могут вызывать другие функции Wippy (Lua или WASM) через хост-интерфейс `wippy:runtime/funcs`:
...
Импортируйте хост `funcs` в конфигурации записи:
