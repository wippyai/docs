...
Для базовой версии Web Host 1.0.56 единственный канонический URL снимка —
`https://web-host.wippy.ai/webcomponents-1.0.56/import-map.json`. Не подставляйте URL локального приложения, незакреплённый URL с `latest` или вручную восстановленный список пакетов.
