...
Opciones de `add*`: `{ method = "store"|"deflate", mode, modified }`. El escritor de zip hace streaming hacia escritores sin búsqueda usando descriptores de datos, así que escribir hacia un stream de respuesta funciona.
