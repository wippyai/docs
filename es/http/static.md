...
Para servir un subdirectorio, apunte la referencia `fs` a una entrada de filesystem cuya raíz sea ese directorio—por ejemplo un `fs.directory` con `directory:` establecido al subdirectorio:
