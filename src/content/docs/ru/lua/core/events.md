...
Публикация и подписка на события для наблюдаемости — мониторинга активности среды выполнения и приложения и реакции на неё.

<note>
Используйте шину событий только для наблюдения: мониторинга, логирования, метрик и реактивных побочных эффектов. Это best-effort publish/subscribe канал, а не надёжный транспорт — не стройте на нём бизнес-логику и не рассчитывайте на гарантированную доставку. Для бизнес-критического обмена сообщениями используйте process messaging (`process.send`), каналы или [очередь сообщений](lua/storage/queue.md).
</note>
