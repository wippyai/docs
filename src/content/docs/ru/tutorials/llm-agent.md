---
title: "LLM-агент"
description: "Пошаговое создание терминального чат-агента: от простого вызова LLM до потокового агента с инструментами."
---
...
- [CLI-приложения](tutorials/cli.md) - Паттерны терминального ввода-вывода
- [Процессы](tutorials/processes.md) - Модель процессов и взаимодействие
