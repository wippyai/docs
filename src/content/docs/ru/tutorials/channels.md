---
title: "Каналы и конкурентность"
description: "Каналы в стиле Go для конкурентного программирования внутри процессов."
---
...
- [Процессы](tutorials/processes.md) - Межпроцессное взаимодействие
