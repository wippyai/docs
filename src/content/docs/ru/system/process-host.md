---
title: "Хост процессов"
description: "Хосты процессов управляют выполнением Lua-процессов с помощью планировщика с захватом работы (work-stealing)."
---
...
| Тип | Описание |
|-----|----------|
| `process.lua` | Lua-процесс из исходного кода |
| `process.lua.bc` | Предкомпилированный Lua-байткод |
| `process.wasm` | WebAssembly-процесс (экспериментально) |
...
- [Модуль Process](lua/core/process.md) — запуск и управление процессами из Lua
- [WASM-процессы](wasm/processes.md) — настройка записей `process.wasm`
- [Модель процессов](concepts/process-model.md) — концепции жизненного цикла и супервизии
- [Супервизия](guides/supervision.md) — построение деревьев супервизии
