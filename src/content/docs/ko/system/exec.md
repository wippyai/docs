---
title: "실행기"
description: "명령 실행기는 제어된 환경에서 외부 프로세스를 실행합니다. 두 가지 실행기 타입을 사용할 수 있습니다: 네이티브 OS 프로세스와 Docker 컨테이너."
---
...
[Exec 모듈](lua/dynamic/exec.md)은 명령 실행을 제공합니다:
...
- [Exec 모듈](lua/dynamic/exec.md) - Lua API 레퍼런스
- [프로세스 호스트](system/process-host.md) - Wippy 프로세스를 실행하는 호스트
- [파일시스템](system/filesystem.md) - 작업 디렉토리로 사용되는 파일시스템 엔트리
