...
ランタイムログルーティングを制御します。コンソール出力は[CLIフラグ](guide-cli.md)（`-v`, `-c`, `-s`）で設定します。
...
グローバルセキュリティ動作。個別のポリシーは[security.policyエントリ](guide-entry-kinds.md)として定義されます。
...
参照: [セキュリティシステム](system-security.md), [セキュリティモジュール](lua-security.md)
...
参照: [レジストリコンセプト](concept-registry.md), [レジストリモジュール](lua-registry.md)
...
参照: [プロセスモデル](concept-process-model.md)
...
参照: [スーパービジョンガイド](guide-supervision.md)
...
参照: [関数コンセプト](concept-functions.md), [Funcsモジュール](lua-funcs.md)
...
参照: [可観測性ガイド](guide-observability.md)
...
参照: [メトリクスモジュール](lua-metrics.md), [可観測性ガイド](guide-observability.md)
...
- [CLIリファレンス](guide-cli.md) - コマンドラインオプション
- [エントリ種別](guide-entry-kinds.md) - すべてのエントリタイプ
- [クラスタガイド](guide-cluster.md) - マルチノードセットアップ
- [可観測性ガイド](guide-observability.md) - ロギング、メトリクス、トレーシング
