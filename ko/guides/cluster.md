...
관련 클러스터 설정은 [구성](guides/configuration.md#클러스터)을 참조하세요. 다음 최소 형태에는 필수 노드 간 ID 설정이 포함됩니다.
...
클러스터 상태는 표준 [Prometheus 엔드포인트](guides/observability.md)와 활성 상태 검사에 노출됩니다.
...
- [관찰 가능성](guides/observability.md) — 메트릭과 상태 엔드포인트
